          ...
          v-card(height='100%')
            ...
            v-card-text
              p
                ...
                | これらに答えをくれるのが統計指標です。
              p
                | KabuCalculatorでは価格水準、リターン、リスクを表す指標を用意しています。
              p
                | チャートを見て感覚的な捉えることも重要ですが、数値としても客観的に把握することも重要です。
        v-col(cols='12' xs='12' sm='6')
          v-card(height='100%')
            v-card-title
              | 比較 
            v-card-text
              p
                | 偏差値という指標がいい点は性質の異なる数学や英語などのテストを比べることが出来ることです。 
              p
                | KabuCalculatorでは偏差値のように価格水準を把握することができ、
                br
