...
class IndicatorTest < ActiveSupport::TestCase
  ...
  test '.filter_by_price_in_case_of_lower_value_nil' do
    @price[:upper] = 100
    actual_indicators = Indicator.filter_by_price(@price)
    assert_equal ['1234'], actual_indicators.pluck(:symbol)
  end

  test '.filter_by_price_in_case_of_both_value_nil' do
    actual_indicators = Indicator.filter_by_price(@price)
    assert_equal %w[1234 1235 1236 1237], actual_indicators.pluck(:symbol).sort
  end

  test '.filter_by_myuhat_short_in_case_of_both_value_filled' do
  ...
  test '.filter_by_@myuhat_short_in_case_of_lower_value_nil' do
    @myuhat[:short][:upper] = 0
    actual_indicators = Indicator.filter_by_myuhat(@myuhat)
    assert_equal ['1236'], actual_indicators.pluck(:symbol)
  end

  test '.filter_by_myuhat_in_case_of_all_value_nil' do
    actual_indicators = Indicator.filter_by_myuhat(@myuhat)
    assert_equal %w[1234 1235 1236 1237], actual_indicators.pluck(:symbol).sort
  end

  test '.filter_by_sigmahat_short_in_case_of_both_value_filled' do
  ...
  test '.filter_by_sigmahat_short_in_case_of_lower_value_nil' do
    @sigmahat[:short][:upper] = 0.02
    actual_indicators = Indicator.filter_by_sigmahat(@sigmahat)
    assert_equal ['1237'], actual_indicators.pluck(:symbol)
  end

  test '.filter_by_sigmahat_in_case_of_all_value_nil' do
    actual_indicators = Indicator.filter_by_sigmahat(@sigmahat)
    assert_equal %w[1234 1235 1236 1237], actual_indicators.pluck(:symbol).sort
  end

  test '.filter_by_probability_short_in_case_of_both_value_filled' do
  ...
  test '.filter_by_probability_short_in_case_of_upper_value_nil' do
    @probability[:short][:lower] = -0.2
    actual_indicators = Indicator.filter_by_probability(@probability)
    assert_equal ['1237'], actual_indicators.pluck(:symbol)
  end

  test '.filter_by_probability_in_case_of_all_value_nil' do
    actual_indicators = Indicator.filter_by_probability(@probability)
    assert_equal %w[1234 1235 1236 1237], actual_indicators.pluck(:symbol).sort
  end

  test '.filter_by_myuhat_medium_in_case_of_both_value_filled' do
  ...
  test '.filter_by_myuhat_medium_in_case_of_lower_value_nil' do
    @myuhat[:medium][:upper] = 0
    actual_indicators = Indicator.filter_by_myuhat(@myuhat)
    assert_equal %w[1234 1235 1236 1237], actual_indicators.pluck(:symbol).sort
  end

  test '.filter_by_sigmahat_medium_in_case_of_both_value_filled' do
  ...
  test '.filter_by_sigmahat_medium_in_case_of_lower_value_nil' do
    @sigmahat[:medium][:upper] = 0.02
    actual_indicators = Indicator.filter_by_sigmahat(@sigmahat)
    assert_equal ['1237'], actual_indicators.pluck(:symbol)
  end

  test '.filter_by_probability_medium_in_case_of_both_value_filled' do
  ...
  test '.filter_by_probability_medium_in_case_of_upper_value_nil' do
    @probability[:medium][:lower] = -0.2
    actual_indicators = Indicator.filter_by_probability(@probability)
    assert_equal %w[1234 1235 1237], actual_indicators.pluck(:symbol).sort
  end

  test '.filter_by_myuhat_long_in_case_of_both_value_filled' do
  ...
  test '.filter_by_myuhat_long_in_case_of_lower_value_nil' do
    @myuhat[:long][:lower] = 0
    actual_indicators = Indicator.filter_by_myuhat(@myuhat)
    assert_equal %w[1234 1235 1237], actual_indicators.pluck(:symbol).sort
  end

  test '.filter_by_sigmahat_long_in_case_of_both_value_filled' do
  ...
  test '.filter_by_sigmahat_long_in_case_of_lower_value_nil' do
    @sigmahat[:long][:upper] = 0.02
    actual_indicators = Indicator.filter_by_sigmahat(@sigmahat)
    assert_equal ['1237'], actual_indicators.pluck(:symbol)
  end

  test '.filter_by_probability_long_in_case_of_both_value_filled' do
  ...
  test '.filter_by_probability_long_in_case_of_upper_value_nil' do
  ...
  test '.filter_by(symbols=XXXX,XXXX&price_uppervalue=XX)' do
    symbols = %w[1234 1235]
    @price[:upper] = 100
  ...
  test '.filter_by(probability&&myuhat&&sigmahat)' do
    @probability[:long][:lower] = -0.5
    @probability[:long][:upper] = -0.2
    @sigmahat[:medium][:upper] = 0.02
    @myuhat[:short][:lower] = 0.01
